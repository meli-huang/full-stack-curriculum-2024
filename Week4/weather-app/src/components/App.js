  ...
  return (
    <div className="app-container">
      ...
      */}
      ...
      /* Pass the selected city data as props to 'MainContainer' */ />
      <SideContainer apiKey={apiKey} setSelectedCity={updateCity}
      /* Pass the city data update function as a prop to 'SideContainer' */ />
    </div>
  );
}
